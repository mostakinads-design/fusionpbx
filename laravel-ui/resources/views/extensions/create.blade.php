...
<div class="bg-white rounded-lg shadow-md p-6">
    <h3 class="text-2xl font-bold text-gray-800 mb-6">Create New Extension</h3>
    ...
    <form action="{{ route('extensions.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Password -->
            <div>
                <label for="password" class="block text-sm font-medium text-gray-700 mb-2">SIP Password *</label>
            ...
            <div class="flex items-center">
                <label class="flex items-center space-x-2">
                    <input type="checkbox" name="voicemail_enabled" value="1" {{ old('voicemail_enabled', true) ? 'checked' : '' }}
        ...
        <div class="mt-8 flex justify-end space-x-4">
            ...
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg">
                <i class="fas fa-save mr-2"></i> Create Extension
            </button>
        </div>
    </form>
</div>
